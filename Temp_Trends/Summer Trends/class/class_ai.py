...
class Temperature_Data:
    ...
    across multiple years and months using daily records.
    ...
    def __init__(self, dfs):
        ...
        self.years = years
        self.dfs = dfs
        self.first = True  # Flag to avoid recursive calls to _fix_zeros()
    ...
    def _fix_zeros(self, frame, year):
        ...
        for month in months:
            self.first = False  # Important to avoid recursive _fix_zeros
