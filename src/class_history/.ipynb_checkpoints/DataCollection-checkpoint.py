""" 
This script defines a class that easily pulls the temperature data. I have wrote several functions that I anticpate I will use repeatedly in my analysis. 

check_length_of_month: pass an integer of the number of days you counted in a month in a given year, verify that it is the correct number of days you would expect.

collect_month: Collects all temperature data for a given month in a given year. Mode selects high, averages, or lows.

colllect_day: Collects temperature data for a given day for all years 1960-2024. Mode selects high, averages, or lows.

plot_hist: Plots a histogram of the data you pass. 
